...
define ("HASHER_HASH_COUNTS_BY_YEAR","SELECT YEAR(EVENT_DATE), COUNT(*) AS THE_COUNT
 FROM
	HASHINGS
    JOIN HASHES ON HASHINGS.HASH_KY = HASHES.HASH_KY
  WHERE
...
define("HASHER_HASH_COUNTS_BY_MONTH","SELECT MONTH(EVENT_DATE), COUNT(*) AS THE_COUNT
 FROM
	HASHINGS
    JOIN HASHES ON HASHINGS.HASH_KY = HASHES.HASH_KY
  WHERE
...
define("HASHER_HASH_COUNTS_BY_QUARTER","SELECT QUARTER(EVENT_DATE), COUNT(*) AS THE_COUNT
 FROM
	HASHINGS
    JOIN HASHES ON HASHINGS.HASH_KY = HASHES.HASH_KY
  WHERE
...
define("HASHER_HASH_COUNTS_BY_DAYNAME","SELECT DAYNAME(EVENT_DATE), COUNT(*) AS THE_COUNT
 FROM
	HASHINGS
    JOIN HASHES ON HASHINGS.HASH_KY = HASHES.HASH_KY
  WHERE
...
define("HASHER_HASH_COUNTS_BY_STATE","SELECT HASHES.EVENT_STATE, COUNT(*) AS THE_COUNT
 FROM
	HASHINGS
    JOIN HASHES ON HASHINGS.HASH_KY = HASHES.HASH_KY
  WHERE
...
define("HASHER_HASH_COUNTS_BY_CITY","SELECT HASHES.EVENT_CITY, COUNT(*) AS THE_COUNT
 FROM
	HASHINGS
    JOIN HASHES ON HASHINGS.HASH_KY = HASHES.HASH_KY
  WHERE
