...
ALTER TABLE HASHES ADD `HASH_TYPE` BIT(64);

UPDATE HASHES SET HASH_TYPE=1<<0 WHERE IS_HYPER=0;
UPDATE HASHES SET HASH_TYPE=1<<1 WHERE IS_HYPER=1;

ALTER TABLE KENNELS ADD HASH_TYPE_MASK BIT(64);

UPDATE KENNELS SET HASH_TYPE_MASK = 1<<0 | 1<<1;

ALTER TABLE KENNELS CHANGE HASH_TYPE_MASK HASH_TYPE_MASK BIT(64) NOT NULL;
